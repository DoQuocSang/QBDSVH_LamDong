...
export default ({ type = "" }) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      managementUnit.image_360_url === null
    ) {
    ...
    if (id !== 0) {
      getManagementUnitById(id).then((data) => {
        ...
        else setManagementUnit(initialState);
        console.log(data);
      });
    }
    ...
    uploadTask.on(
      ...
      async () => {
        try {
          ...
          putManagementUnitImage360(id, { image_360_url: downloadURL }).then(
            (data) => {
              console.log(data);
            }
          );
  ...
  const clearImageFile = () => {
    ...
    var ModelName = getFileNameFromURL(
      managementUnit.image_360_url,
      "panoramas%2F"
    );
    if (ModelName) {
      ...
      <div className="mt-12 px-4">
        <div className="bg-white editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
          ...
          <div className="mt-2 mb-8">
            <div className="grid w-full gap-6 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-2">
              <div className="flex flex-col overflow-hidden rounded p-2 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="relative pb-[80%]">
                  <img
                    src={"https://firebasestorage.googleapis.com/v0/b/qbdsvhlamdong.appspot.com/o/panoramas%2FBaotangLD10.jpg?alt=media&token=74a26266-0c1d-4c1e-b68f-78a125185f04"}
                    alt=""
                  ...
                  <div className="absolute bottom-0 left-0 z-20 w-full rounded-b bg-gray-700 bg-opacity-70 px-3 py-2">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="mb-1 text-xs text-white">Số hotspot: 10</p>
              ...
              <div 
                onClick={() => {alert("them di")}}
                className="flex flex-col overflow-hidden rounded p-2 group shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                <div
                    className="w-full h-full rounded flex flex-col justify-center items-center bg-gray-100 group-hover:bg-gray-200  transition-all duration-300 "
                >
                    <svg
                  ...
                  <span className="text-gray-500 font-semibold mb-1">Thêm khu vực</span>
          ...
          <div>
            ...
            >
              ...
              <div
                className={
                  uploadSectionVisible && !managementUnit.image_360_url
