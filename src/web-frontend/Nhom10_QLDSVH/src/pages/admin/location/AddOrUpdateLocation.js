...
import {
  addLocation,
  getLocationById,
} from "../../../services/LocationRepository";
    ...
    <main>
      <div className="mt-12 px-4">
        <div className="bg-white editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
          ...
          <h2 className="font-semibold text-sm text-teal-500">Tên địa điểm</h2>
          <input
            name="name"
            required
            type="text"
          ...
          <div className="buttons flex">
            <hr className="mt-4" />
            <Link
              to="/admin/dashboard/all-location"
