...
export default ({
  ...
  description = "Nếu bạn đăng gặp phải khó khăn trong khi sử dụng trang web Di sản văn hóa Lâm Đồng để xem hoặc quản lý thông tin di sản văn hóa, hãy đọc các ý bên dưới.",
  faqs = [
    {
      question: "Di sản văn hóa Lâm Đồng là trang web gì?",
      answer:
        "Di sản văn hóa Lâm Đồng là một trang web cung cấp thông tin và quản lý di sản văn hóa tại Việt Nam. Trang web này được thiết kế để giúp người dùng khám phá, tìm hiểu và trải nghiệm về các di sản văn hóa độc đáo và quan trọng của nước ta. Bạn có thể tìm thấy thông tin chi tiết về các di sản văn hóa, bao gồm mô tả, hình ảnh, địa điểm và các thông tin liên quan khác. Ngoài ra, Di sản văn hóa Lâm Đồng cũng cung cấp các tính năng cho việc quản lý của admin."
    },
    {
