...
const MediaTaskbar = ({ pannellumRef, increaseStep = 10 }) => {
  ...
  return (
    <>
      <div className="absolute bottom-6 z-50 w-full flex justify-center items-center">
        <div
          style={{
          ...
          className="flex-1 text-white font-semibold text-xl rounded-md px-4 py-2 mx-56 flex justify-between items-center w-full"
        >
